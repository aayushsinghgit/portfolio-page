...
const fallbackLocalResponse = (userInput, isHindi) => {
  ...
  if (q.includes('project') || q.includes('प्रोजेक्ट') || q.includes('portfolio')) {
    return isHindi
      ? 'मुख्य प्रोजेक्ट्स: CoCo (multi-agent AI platform), AI Chatbot (RAG + Voice), और Ethereum Crypto Wallet।'
      : 'Key projects: CoCo (multi-agent AI platform at coco17.netlify.app), an AI Chatbot with RAG + Voice, and an Ethereum Crypto Wallet.';
  }
  if (q.includes('experience') || q.includes('infosys') || q.includes('अनुभव')) {
    return isHindi
      ? 'आयुष के पास Infosys में 3.5+ वर्षों का GenAI अनुभव है। उन्होंने ~30% हेलुसिनेशन कम करने में सफलता पाई है।'
      : 'Ayush has 3.5+ years of GenAI experience at Infosys. He achieved ~30% hallucination reduction across 5+ production deployments.';
  }
  return isHindi
