  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Amazon Bedrock', icon: 'https://cdn.simpleicons.org/amazonaws' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Pinecone', icon: 'https://cdn.simpleicons.org/blueprint' },
    ...
    },
    {
      ...
      skills: [
        { name: 'Guardrails', icon: 'https://cdn.simpleicons.org/auth0' },
        { name: 'Policy Enforcement', icon: 'https://cdn.simpleicons.org/probot' },
        { name: 'Red-Teaming', icon: 'https://cdn.simpleicons.org/bugsnag' },
        { name: 'Hallucination Detection', icon: 'https://cdn.simpleicons.org/looker' }
      ]
    },
    {
      key: 'cloud_dev',
                  ...
                  >
                    <div className="w-5 h-5 opacity-80 group-hover/skill:opacity-100 transition-opacity duration-300">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = 'https://cdn.simpleicons.org/probot';
                        }}
                      />
                    </div>
